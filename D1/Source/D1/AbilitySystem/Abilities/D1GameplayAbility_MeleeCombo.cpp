...
void UD1GameplayAbility_MeleeCombo::HandleTargetData(const FGameplayAbilityTargetDataHandle& InTargetDataHandle)
{
	if (bBlocked)
		return;
...
void UD1GameplayAbility_MeleeCombo::TryContinueToNextStage()
{
