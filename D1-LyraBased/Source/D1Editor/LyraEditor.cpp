 ...
 * FLyraEditorModule
 */
class FD1EditorModule : public FDefaultGameModuleImpl
{
	typedef FD1EditorModule ThisClass;
	...
	virtual void StartupModule() override
	{
		...
		if (!IsRunningGame())
		{
			FModuleManager::Get().OnModulesChanged().AddRaw(this, &FD1EditorModule::ModulesChangedCallback);
...
IMPLEMENT_MODULE(FD1EditorModule, D1Editor);
