...
#include "D1GameplayAbility_Interact_Monster.generated.h"

UCLASS()
class UD1GameplayAbility_Interact_Monster : public UD1GameplayAbility_Interact_Object
{
	GENERATED_BODY()
	
public:
	UD1GameplayAbility_Interact_Monster(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
