...
void UD1InventorySlotsWidget::NativeOnInitialized()
{
	...
	DelegateHandle = InventoryManagerComponent->OnInventoryEntryChanged.AddUObject(this, &ThisClass::OnInventoryEntryChanged);
}
...
bool UD1InventorySlotsWidget::NativeOnDrop(const FGeometry& InGeometry, const FDragDropEvent& InDragDropEvent, UDragDropOperation* InOperation)
{
	...
	DragDrop->ToInventoryManager = InventoryManagerComponent;
