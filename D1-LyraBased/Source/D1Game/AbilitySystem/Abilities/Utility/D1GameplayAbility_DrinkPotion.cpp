#include "D1GameplayAbility_DrinkPotion.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(D1GameplayAbility_DrinkPotion)

UD1GameplayAbility_DrinkPotion::UD1GameplayAbility_DrinkPotion(const FObjectInitializer& ObjectInitializer)
...
void UD1GameplayAbility_DrinkPotion::OnDrinkBegin(FGameplayEventData Payload)
{
	bItemUsed = true;
	ApplyUtilityGameplayEffect();
}

void UD1GameplayAbility_DrinkPotion::OnMontageFinished()
{
...
void UD1GameplayAbility_DrinkPotion::ApplyUtilityGameplayEffect()
{
