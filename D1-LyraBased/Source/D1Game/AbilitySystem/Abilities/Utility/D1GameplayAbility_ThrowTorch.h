...
#include "D1GameplayAbility_ThrowTorch.generated.h"

class AD1PickupableItemBase;
class UAbilityTask_WaitInputRelease;

UCLASS()
class UD1GameplayAbility_ThrowTorch : public UD1GameplayAbility_Consume
{
	GENERATED_BODY()
	
public:
	UD1GameplayAbility_ThrowTorch(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
