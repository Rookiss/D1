...
#include "D1GameplayAbility_Bow_Projectile.generated.h"

class AD1ProjectileBase;

UCLASS()
class UD1GameplayAbility_Bow_Projectile : public UD1GameplayAbility_Equipment
{
	GENERATED_BODY()
	
public:
	UD1GameplayAbility_Bow_Projectile(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
