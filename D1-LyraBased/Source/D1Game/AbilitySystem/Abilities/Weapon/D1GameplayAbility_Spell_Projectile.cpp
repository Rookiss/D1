#include "D1GameplayAbility_Spell_Projectile.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(D1GameplayAbility_Spell_Projectile)

UD1GameplayAbility_Spell_Projectile::UD1GameplayAbility_Spell_Projectile(const FObjectInitializer& ObjectInitializer)
...
void UD1GameplayAbility_Spell_Projectile::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
...
void UD1GameplayAbility_Spell_Projectile::EndAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, bool bReplicateEndAbility, bool bWasCancelled)
{
	ResetSpell();
...
void UD1GameplayAbility_Spell_Projectile::ConfirmSpell()
{
	ResetSpell();
...
void UD1GameplayAbility_Spell_Projectile::CancelSpell()
{
	ResetSpell();
...
void UD1GameplayAbility_Spell_Projectile::ResetSpell()
{
...
void UD1GameplayAbility_Spell_Projectile::OnCastStartBegin(FGameplayEventData Payload)
{
	UGameplayMessageSubsystem& MessageSubsystem = UGameplayMessageSubsystem::Get(this);
...
void UD1GameplayAbility_Spell_Projectile::OnSpellStart(FGameplayEventData Payload)
{
	SpawnProjectile();
}

void UD1GameplayAbility_Spell_Projectile::OnMontageFinished()
{
	EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, false);
}

void UD1GameplayAbility_Spell_Projectile::OnInputConfirm()
{
	if (InputCancelTask)
	{
		InputCancelTask->EndTask();
...
void UD1GameplayAbility_Spell_Projectile::OnInputCancel()
{
	CancelSpell();
}

void UD1GameplayAbility_Spell_Projectile::OnPhaseTimePassed()
{
	CurrentIndex++;
...
void UD1GameplayAbility_Spell_Projectile::SpawnProjectile()
{
