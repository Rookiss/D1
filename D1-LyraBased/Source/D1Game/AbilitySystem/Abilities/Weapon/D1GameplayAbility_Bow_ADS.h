...
#include "D1GameplayAbility_Bow_ADS.generated.h"
...
UCLASS()
class UD1GameplayAbility_Bow_ADS : public UD1GameplayAbility_Equipment
{
	GENERATED_BODY()
	
public:
	UD1GameplayAbility_Bow_ADS(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
