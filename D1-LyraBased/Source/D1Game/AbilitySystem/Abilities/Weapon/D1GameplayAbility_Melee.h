...
#include "D1GameplayAbility_Melee.generated.h"

class AD1EquipmentBase;

UCLASS()
class UD1GameplayAbility_Melee : public UD1GameplayAbility_Equipment
{
	GENERATED_BODY()
	
public:
	UD1GameplayAbility_Melee(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
