...
#include "D1GameplayAbility_Block.generated.h"

UCLASS()
class UD1GameplayAbility_Block : public UD1GameplayAbility_Equipment
{
	GENERATED_BODY()
	
public:
	UD1GameplayAbility_Block(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
