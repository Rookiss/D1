...
#include "D1GameplayAbility_Spell_Projectile.generated.h"
...
UCLASS()
class UD1GameplayAbility_Spell_Projectile : public UD1GameplayAbility_Equipment
{
	GENERATED_BODY()
	
public:
	UD1GameplayAbility_Spell_Projectile(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
