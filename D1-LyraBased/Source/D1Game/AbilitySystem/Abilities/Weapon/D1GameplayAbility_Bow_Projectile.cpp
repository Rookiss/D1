...
#include UE_INLINE_GENERATED_CPP_BY_NAME(D1GameplayAbility_Bow_Projectile)

UD1GameplayAbility_Bow_Projectile::UD1GameplayAbility_Bow_Projectile(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
    
}

void UD1GameplayAbility_Bow_Projectile::SpawnProjectile()
{
